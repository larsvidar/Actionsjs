 ...
 */
export var safeWindow = function () {
 ...
 */
export var compareArray = function (arr1, arr2) {
    arr1 = safeArray(arr1);
    arr2 = safeArray(arr2);
 ...
 * @returns {string}
*/
export var isoToAnsi = function (str) {
    if (str === void 0) { str = ''; }
 ...
 * @returns {string}
*/
export var ansiToIso = function (str) {
    if (str === void 0) { str = ''; }
    return str
        .replace(/\+o/g, 'ø')
        .replace(/\+O/g, 'Ø')
 ...
 */
export var stringifyLink = function (link) {
    if (link) {
 ...
 */
export var toHours = function (minutes, loc) {
    //Language locale
    if (!loc)
        loc = {
            minutesShort: 'm',
 ...
 */
export var toMinutes = function (seconds, loc) {
    //Language locale
    if (!loc)
        loc = {
            secondsShort: 's',
 ...
 */
export var resizeImage = function (file, options) { return __awaiter(void 0, void 0, void 0, function () {
 ...
 */
export var sortObjectArray = function (array, key, sort) {
 ...
 */
export var stringCheck = function (value) {
 ...
 */
export var getTimeSince = function (date, short) {
 ...
 */
export var genUid = function (size) {
 ...
 */
export var formatDate = function (rawDate, format) {
 ...
 */
export var makePdf = function (element, name) { return __awaiter(void 0, void 0, void 0, function () {
 ...
 */
export var isEmpty = function (data) {
 ...
 */
export var removeEmpty = function (data) {
    if (typeof data !== 'object')
        return data;
    if (data instanceof Date)
        return data;
    if (Array.isArray(data)) {
        ...
        var newArr = data.filter(function (value) { return !isEmpty(value); });
        console.log(newArr);
        return newArr;
    }
    var keys = Object.keys(data);
 ...
 * @returns
 */
export var prependUrl = function (urlPrefix, url) {
 ...
 */
export var isValid = function (value) {
 ...
 */
export function paginateArray(source, quantity) {
    var target = [];
 ...
 * @return {void}
 */
export var setTime = function (text, end) { return end
 ...
 */
export var sortFromArray = function (targetArray, sourceArray, compareKey) {
 ...
 * @param type
 */
export var noError = function (data, type) {
    if (!isError(data))
        return data;
    switch (type) {
        case 'string': return '';
 ...
 */
export var getTimeoutObject = function () {
    return {
 ...
 * @returns {genObject}
 */
export var stringToObject = function (str) {
    str = safeString(str);
 ...
 */
export var serializeForm = function (form, target) {
    var _a;
    //Checking values
    var FAILSAFE = 1000;
    if (!form)
        return {};
    var targetObject = isObject(target) ? target : {};
    //Trying to get entries from form-data.
    var formData = tryCatch(function () { return new FormData(form).entries(); });
    if (isError(formData))
        return {};
...
export function handleEvent(event, stopPropagation) {
 ...
 */
export var formatNumber = function (value, separator) {
 ...
 */
export var tryCatch = function (action) {
    try {
        return action();
    }
    catch (error) {
 ...
 * @return {string}
 */
export var stringify = function (data, indention) {
 ...
 * @return {string}
 */
export var constructParamsString = function (params) {
    var paramString = '';
    if (!isObject(params))
        return paramString;
 ...
 */
export var openWindow = function (url, width, height, top, left) {
    var _a, _b, _c;
    if (width === void 0) { width = 480; }
    if (height === void 0) { height = 640; }
    //Variables
    if (!top)
        top = (((_a = safeWindow()) === null || _a === void 0 ? void 0 : _a.screen.height) / 3) - (height / 2);
    if (!left)
        left = (((_b = safeWindow()) === null || _b === void 0 ? void 0 : _b.screen.width) / 2) - (width / 2);
    //Open new window
    var newWindow = (_c = safeWindow()) === null || _c === void 0 ? void 0 : _c.open(url, '_blank', "top=".concat(top, ",left=").concat(left, ",width=").concat(width, ",height=").concat(height));
    if (!newWindow) {
 ...
 * @return {void}
 */
export var setHash = function (hash) {
    location.hash = '';
    location.hash = hash;
};
/**
 ...
 */
export function appendPagination(arr, page, itemsPrPage) {
...
export var isWebAdresse = function (url) {
    return safeString(url).substr(0, 4) === 'http';
};
export var prependSlash = function (url) {
    url = safeString(url);
 ...
 * @return {string}
 */
export function noPreSlash(url) {
    url = safeString(url);
    return url.substr(0, 1) === '/'
 ...
 * @return {string}
 */
export function noWrappingSlash(url) {
 ...
 * @returns {string[]}
 */
export var urlToArray = function (url) {
    var _a, _b;
 ...
 * @return {string}
 */
export var getSlug = function (url) {
 ...
 */
export var getMonth = function (rawDate, format, loc) {
 ...
 */
export function map(arr, action) {
    if (arr === void 0) { arr = []; }
 ...
 */
export function filter(arr, action) {
    if (arr === void 0) { arr = []; }
 ...
 * @returns {any[]} Filtered array
 */
export function find(arr, action) {
    if (arr === void 0) { arr = []; }
    if (action === void 0) { action = function () { return false; }; }
 ...
 */
export function forEach(arr, action) {
    if (arr === void 0) { arr = []; }
    if (action === void 0) { action = function (item) { return item; }; }
 ...
 */
export function split(value, param) {
 ...
 */
export var hasChanges = function (source, data) {
 ...
 */
export var removeDuplicateArrayObjects = function (array, key) {
    var newArray = [];
    var existingValues = [];
 ...
 * @returns {string}
 */
export var objToUrlParams = function (queryObject) {
    var queryString = '';
    if (!queryObject)
        return '';
 ...
 */
export var offsetArray = function (arr, offset) {
    var newArray = [];
 ...
 */
export var shallowEqualObject = function (object1, object2) {
 ...
 */
export var removeExcessiveNewLines = function (text) {
 ...
 * @returns {string}
 */
export var removeUrlParams = function (url) {
 ...
 */
export function updateArray(array, updatedItem, query, keepOldData) {
 ...
 */
export function addOrReplace(data, targetArray, key, replace) {
    ...
    var findSameItem = function (newData, oldItem, key) {
        return find(newData, function (dataItem) {
            ...
            var itemValue = (key ? oldItem[key] : oldItem) || genUid(16);
 ...
 * @returns
 */
export var propClass = function (nativeClass, propClass) {
 ...
 */
export var jsonParse = function (data) {
    var result = tryCatch(function () { return JSON.parse(data); });
    if (isError(result))
        return data;
    return result;
};
 ...
 */
export var handlePromise = function (promise, undefinedError, target) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                ...
                if (isObject(target) && isObject(result))
 ...
 */
export var easyPromise = function (promise) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, handlePromise(promise, 'I promise nothing!!!')];
            case 1:
                result = _a.sent();
                if (isError(result))
 ...
 */
export var firstUpperCase = function (text) {
    if (text) {
 ...
 */
export var removeUndefined = function (object) {
    //New empty object.
    var newObject = {};
 ...
 */
export var checkForErrors = function (data, error) {
 ...
 */
export var emptyObject = function (data) {
    var keys = Object.keys(data);
 ...
 * @return {string}
 */
export var removeHtml = function (message) {
    return message
 ...
 * @return {string}
 */
export var decode64 = function (value) {
 ...
 * @return {void}
 */
export var printString = function (data, label) {
    isError(data)
 ...
 */
export var getDate = function (day, month, year) {
    var date = new Date();
 ...
 */
export var customError = function (prefix) {
 ...
 */
export var filterProps = function (data, fields) {
    //Check parameters
    if (isEmpty(data) ||
        isEmpty(fields) ||
        !isObject(data) ||
 ...
 */
export var isEqualDates = function (date1, date2, threshold) {
 ...
 * @returns {any[]} Array with duplicates removed
 */
export var removeDuplicateObjects = function (array, key) {
    var newArray = [];
    var existingValues = [];
 ...
 * @returns {string}
 */
export var toLowerCase = function (str) {
    var _a, _b;
    if (str === void 0) { str = ''; }
 ...
 */
export var getFieldName = function (fields, value) {
